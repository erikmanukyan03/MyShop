    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PAVsId = table.Column<int>(type: "int", nullable: false),
                    ProductsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_PAV", x => new { x.PAVsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_Product_PAV_ProductAttributeValues_PAVsId",
                        column: x => x.PAVsId,
                        principalTable: "ProductAttributeValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_PAV_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_PAV_ProductsId",
                table: "Product_PAV",
                column: "ProductsId");
